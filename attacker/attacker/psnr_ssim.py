...
class Metric():
    ...
    def calculate_psnr_pt(self, img, img2, crop_border, test_y_channel=False, **kwargs):
    ...
    def calculate_ssim_pt(self, img, img2, crop_border, test_y_channel=False, **kwargs):
        """Calculate SSIM (structural similarity) (PyTorch version).
